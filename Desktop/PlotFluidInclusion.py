...
class PlotFluidInclusion(QWidget):
    ui = Ui_TASPlot()

    def __init__(self,parent=None):
        super(PlotFluidInclusion, self).__init__(parent)
        self.setupUi()
        self.df = None
    ...
    def doPlot(self):
        ...
        if hasattr(w,"df"):
            ...
            taspop = FluidInclusion(df=df,parent=myservice.main_window)

            taspop.FluidInclusion()
            taspop.setWindowTitle("Fluid Inclusion  Plot")

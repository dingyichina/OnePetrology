...
class PlotREE(QWidget):
    ui = Ui_TASPlot()

    def __init__(self,parent=None):
        super(PlotREE, self).__init__(parent)
        self.setupUi()
        self.df = None
    ...
    def doPlot(self):
        ...
        # 做校验，把每个列的类型做校验，如果不对，则转换类型，转换失败的数据则丢掉['La', 'Ce', 'Pr', 'Nd', 'Sm', 'Eu', 'Gd', 'Tb', 'Dy', 'Ho', 'Er', 'Tm', 'Yb', 'Lu']
        datalist = [{"Name": "Label", "Desc": "点的标签值", "Type": "String", "UseDefault": False, "DefaultValue": "a"},
                    ...
                    {"Name": "Alpha", "Desc": "透明度，默认0.6，取值范围0~1", "Type": "Float", "UseDefault": True,
                     "DefaultValue": "0.6"},
                    ...
                    {"Name": "Eu", "Desc": "Eu", "Type": "Float", "UseDefault": False, "DefaultValue": "0"},
        ...
        if hasattr(w,"df"):
            ...
            taspop = REE(df=df, parent=myservice.main_window)

            taspop.REE()
            taspop.setWindowTitle("REE Plot")

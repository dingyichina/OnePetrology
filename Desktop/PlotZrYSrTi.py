...
class PlotZrYSrTi(QWidget):
    ui = Ui_TASPlot()

    def __init__(self,parent=None):
        super(PlotZrYSrTi, self).__init__(parent)
        self.setupUi()
        self.df = None
    ...
    def doPlot(self):
        ...
        if hasattr(w,"df"):
            ...
            taspop = ZrYSrTi(df=df,parent=myservice.main_window)

            taspop.Key_Func()
            taspop.setWindowTitle("Zr, Ti, Y and Sr analyses of oceanic basalts Plot")

 ...
 */
@Component
public class DPReOsmiumDirective extends AbstractTemplateDirective {

    @Override
    public void execute(RenderHandler handler) throws IOException, Exception {
        Integer id = handler.getInteger("id");
        if (CommonUtils.notEmpty(id)) {
            DPReOsmium entity = service.getEntity(id);
            if (null != entity) {
            ...
            if (CommonUtils.notEmpty(ids)) {
                List<DPReOsmium> entityList = service.getEntitys(ids);
                Map<String, DPReOsmium> map = new LinkedHashMap<>();
                for (DPReOsmium entity : entityList) {

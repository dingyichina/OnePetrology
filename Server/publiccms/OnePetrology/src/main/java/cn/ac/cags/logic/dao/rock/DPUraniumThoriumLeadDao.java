...
/**
 *
 * DPUraniumThoriumLeadDao
 * 
 */
@Repository
public class DPUraniumThoriumLeadDao extends BaseDao<DPUraniumThoriumLead> {
    ...
    public PageHandler getPage(Integer sampleId, 
        ...
        QueryHandler queryHandler = getQueryHandler("from DPUraniumThoriumLead bean");
    ...
    @Override
    protected DPUraniumThoriumLead init(DPUraniumThoriumLead entity) {
        return entity;
    }

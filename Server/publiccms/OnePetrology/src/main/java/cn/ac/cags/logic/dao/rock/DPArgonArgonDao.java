 ...
 */
@Repository
public class DPArgonArgonDao extends BaseDao<DPArgonArgon> {
    ...
    public PageHandler getPage(
        ...
        QueryHandler queryHandler = getQueryHandler("from DPArgonArgon bean");
        queryHandler.order("bean.id desc");
        return getPage(queryHandler, pageIndex, pageSize);
    }

    @Override
    protected DPArgonArgon init(DPArgonArgon entity) {
        return entity;
    }

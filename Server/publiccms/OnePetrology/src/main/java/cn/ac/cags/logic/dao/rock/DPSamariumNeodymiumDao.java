...
/**
 *
 * DPSamariumNeodymiumDao
 * 
 */
@Repository
public class DPSamariumNeodymiumDao extends BaseDao<DPSamariumNeodymium> {
    ...
    public PageHandler getPage(Integer sampleId, 
        ...
        QueryHandler queryHandler = getQueryHandler("from DPSamariumNeodymium bean");
    ...
    @Override
    protected DPSamariumNeodymium init(DPSamariumNeodymium entity) {
        return entity;
    }

 ...
 */
@Repository
public class MajorElementDao extends BaseDao<MajorElement> {
    ...
    public PageHandler getPage(Integer sampleId, 
        ...
        QueryHandler queryHandler = getQueryHandler("from MajorElement bean");
    ...
    @Override
    protected MajorElement init(MajorElement entity) {
        return entity;
    }

...
/**
 *
 * RockSectionIdentifyDao
 * 
 */
@Repository
public class RockSectionIdentifyDao extends BaseDao<RockSectionIdentify> {
    ...
    public PageHandler getPage(Integer sampleId, 
        ...
        QueryHandler queryHandler = getQueryHandler("from RockSectionIdentify bean");
    ...
    @Override
    protected RockSectionIdentify init(RockSectionIdentify entity) {
        return entity;
    }

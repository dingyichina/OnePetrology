...
/**
 *
 * DPThermoluminescenceDao
 * 
 */
@Repository
public class DPThermoluminescenceDao extends BaseDao<DPThermoluminescence> {
    ...
    public PageHandler getPage(Integer sampleId, 
        ...
        QueryHandler queryHandler = getQueryHandler("from DPThermoluminescence bean");
    ...
    @Override
    protected DPThermoluminescence init(DPThermoluminescence entity) {
        return entity;
    }

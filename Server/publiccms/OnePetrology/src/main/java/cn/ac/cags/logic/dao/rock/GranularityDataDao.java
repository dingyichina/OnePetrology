 ...
 */
@Repository
public class GranularityDataDao extends BaseDao<GranularityData> {
    ...
    public PageHandler getPage(Integer sampleId, 
        ...
        QueryHandler queryHandler = getQueryHandler("from GranularityData bean");
    ...
    @Override
    protected GranularityData init(GranularityData entity) {
        return entity;
    }

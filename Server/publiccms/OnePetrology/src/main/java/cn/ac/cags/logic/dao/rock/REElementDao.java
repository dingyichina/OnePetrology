 ...
 */
@Repository
public class REElementDao extends BaseDao<REElement> {
    ...
    public PageHandler getPage(Integer sampleId, 
        ...
        QueryHandler queryHandler = getQueryHandler("from REElement bean");
    ...
    @Override
    protected REElement init(REElement entity) {
        return entity;
    }

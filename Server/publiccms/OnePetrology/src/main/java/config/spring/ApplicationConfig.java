 ...
 */
@Configuration
@ComponentScan(basePackages = "com.publiccms, cn.ac.cags", excludeFilters = { @ComponentScan.Filter(value = { Controller.class }) })
@MapperScan(basePackages = "com.publiccms.logic.mapper, cn.ac.cags.logic.mapper")
...
public class ApplicationConfig {
    ...
    public SqlSessionFactoryBean mybatisSqlSessionFactoryBean(DataSource dataSource) throws IOException {
        ...
        configuration.setMapUnderscoreToCamelCase(true);//增加驼峰命名
    ...
    public FactoryBean<SessionFactory> hibernateSessionFactory(DataSource dataSource) throws PropertyVetoException, IOException {
        ...
        bean.setDataSource(dataSource);
        bean.setPackagesToScan(new String[]{"com.publiccms.entities","cn.ac.cags.entities"});//添加自定义的hibernate扫描路径

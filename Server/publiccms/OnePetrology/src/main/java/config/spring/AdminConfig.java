...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "com.publiccms.controller.admin,cn.ac.cags.controller.admin", useDefaultFilters = false, includeFilters = {
...
public class AdminConfig implements WebMvcConfigurer {
    ...
    public AdminContextInterceptor adminInterceptor(TemplateComponent templateComponent) {
        ...
        bean.setNeedNotLoginUrls(new String[] { "/logout", "/changeLocale", "/login", "/getCode"  });
